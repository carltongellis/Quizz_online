      ...
      <table class="table">
        ...
        <ul class="bs-box clerfix">
            <li class="col-md-4 col-sm-12 col-xs-12">
                <a class="panel panel-default" href="Course?bCourse=FPP">
                ...
                <a class="panel panel-default" href="Course?bCourse=MPP">
                    <div class="panel-body text-center">
                        <h3>MPP</h3>
                        <p><button class="btn btn-primary">Click to start</button></p>
                    </div>
                ...
                <a class="panel panel-default" href="Course?bCourse=A Basic Panel">
                    <div class="panel-body text-center">
                        <h3>A Basic Panel</h3>
                        <p><button class="btn btn-primary">Click to start</button></p>
                    </div>
